...
<script lang="ts" module>
	export { GetBaseAlertContext as GetGlobalAlertContext } from "../BaseAlert/BaseAlert.svelte";
</script>
...
<script lang="ts">
	...
	let { centered = true, children, ...restProps }: GlobalAlertProps = $props();
</script>

<BaseAlert {...restProps} {centered} global={true} type="strong" role="alert">
	{@render children()}
</BaseAlert>
